...
export class AnalyticsService
{
     ...
     */
     getWeatherData(lat, long): Observable<any[]> {
        let forecastApi = this._httpClient.get("http://api.openweathermap.org/data/2.5/forecast?lat="+ lat +"&lon="+ long +"&appid=9c7f51ad29e927939e5411b3191d4137");
        let weatherApi = this._httpClient.get("http://api.openweathermap.org/data/2.5/weather?lat="+ lat +"&lon="+ long +"&appid=9c7f51ad29e927939e5411b3191d4137");
